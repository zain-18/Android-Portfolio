        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               /* if (myIncent.isAdReadyToDisplay()) {
                    ...
                    myIncent.show(Page3.this, null, null, new AppLovinAdDisplayListener() {
                        @Override
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.button1:
                ...
                player1 = MediaPlayer.create(Page3.this, R.raw.avengers);
                player1.start();
            ...
            case R.id.button2:
                ...
                player1 = MediaPlayer.create(Page3.this, R.raw.avengers_assemble);
                player1.start();
            ...
            case R.id.button3:
                ...
                player1 = MediaPlayer.create(Page3.this, R.raw.badumtss);
                player1.start();
            ...
            case R.id.button4:
                ...
                player1 = MediaPlayer.create(Page3.this, R.raw.bamboleo);
                player1.start();
            ...
            case R.id.button5:
                ...
                player1 = MediaPlayer.create(Page3.this, R.raw.bananaphone);
                player1.start();
            ...
            case R.id.button6:
                ...
                player1 = MediaPlayer.create(Page3.this, R.raw.banjokazooiechallengelose);
                player1.start();
                break;
            case R.id.button7:
                if (player1 != null && player1.isPlaying()) {
                ...
                player1 = MediaPlayer.create(Page3.this, R.raw.barrelroll);
                player1.start();
                break;
            case R.id.button8:
                if (player1 != null && player1.isPlaying()) {
                ...
                player1 = MediaPlayer.create(Page3.this, R.raw.batman);
                player1.start();
                break;
            case R.id.button9:
                if (player1 != null && player1.isPlaying()) {
                ...
                player1 = MediaPlayer.create(Page3.this, R.raw.bazinga);
                player1.start();
                break;
            case R.id.previous:
