        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               /* if (myIncent.isAdReadyToDisplay()) {
                    ...
                    myIncent.show(Page5.this, null, null, new AppLovinAdDisplayListener() {
                        @Override
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.button1:
                ...
                player1 = MediaPlayer.create(Page5.this, R.raw.bricomania);
                player1.start();
            ...
            case R.id.button2:
                ...
                player1 = MediaPlayer.create(Page5.this, R.raw.brindis);
                player1.start();
            ...
            case R.id.button3:
                ...
                player1 = MediaPlayer.create(Page5.this, R.raw.brook_laugh_yohoho);
                player1.start();
            ...
            case R.id.button4:
                ...
                player1 = MediaPlayer.create(Page5.this, R.raw.bruh);
                player1.start();
            ...
            case R.id.button5:
                ...
                player1 = MediaPlayer.create(Page5.this, R.raw.buzz);
                player1.start();
            ...
            case R.id.button6:
                ...
                player1 = MediaPlayer.create(Page5.this, R.raw.camara_fotos);
                player1.start();
                break;
            case R.id.button7:
                if (player1 != null && player1.isPlaying()) {
                ...
                player1 = MediaPlayer.create(Page5.this, R.raw.cansino);
                player1.start();
                break;
            case R.id.button8:
                if (player1 != null && player1.isPlaying()) {
                ...
                player1 = MediaPlayer.create(Page5.this, R.raw.cantina);
                player1.start();
                break;
            case R.id.button9:
                if (player1 != null && player1.isPlaying()) {
                ...
                player1 = MediaPlayer.create(Page5.this, R.raw.cashregister);
                player1.start();
                break;
            case R.id.previous:
