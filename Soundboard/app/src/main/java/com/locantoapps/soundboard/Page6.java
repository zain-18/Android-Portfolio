        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               /* if (myIncent.isAdReadyToDisplay()) {
                    ...
                    myIncent.show(Page6.this, null, null, new AppLovinAdDisplayListener() {
                        @Override
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.button1:
                ...
                player1 = MediaPlayer.create(Page6.this, R.raw.celebration);
                player1.start();
            ...
            case R.id.button2:
                ...
                player1 = MediaPlayer.create(Page6.this, R.raw.censorbeep);
                player1.start();
            ...
            case R.id.button3:
                ...
                player1 = MediaPlayer.create(Page6.this, R.raw.chala);
                player1.start();
            ...
            case R.id.button4:
                ...
                player1 = MediaPlayer.create(Page6.this, R.raw.champions);
                player1.start();
            ...
            case R.id.button5:
                ...
                player1 = MediaPlayer.create(Page6.this, R.raw.chanchan);
                player1.start();
            ...
            case R.id.button6:
                ...
                player1 = MediaPlayer.create(Page6.this, R.raw.chewbacca);
                player1.start();
                break;
            case R.id.button7:
                if (player1 != null && player1.isPlaying()) {
                ...
                player1 = MediaPlayer.create(Page6.this, R.raw.chucktesta);
                player1.start();
                break;
            case R.id.button8:
                if (player1 != null && player1.isPlaying()) {
                ...
                player1 = MediaPlayer.create(Page6.this, R.raw.circus);
                player1.start();
                break;
            case R.id.button9:
                if (player1 != null && player1.isPlaying()) {
                ...
                player1 = MediaPlayer.create(Page6.this, R.raw.cobratakataka);
                player1.start();
                break;
            case R.id.previous:
