...
public class Page9 extends AppCompatActivity implements View.OnClickListener  {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                /*if (myIncent.isAdReadyToDisplay()) {
                    ...
                    myIncent.show(Page9.this, null, null, new AppLovinAdDisplayListener() {
                        @Override
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.button1:
                ...
                player1 = MediaPlayer.create(Page9.this, R.raw.ding);
                player1.start();
            ...
            case R.id.button2:
                ...
                player1 = MediaPlayer.create(Page9.this, R.raw.dixie);
                player1.start();
            ...
            case R.id.button3:
                ...
                player1 = MediaPlayer.create(Page9.this, R.raw.doh);
                player1.start();
            ...
            case R.id.button4:
                ...
                player1 = MediaPlayer.create(Page9.this, R.raw.doit);
                player1.start();
            ...
            case R.id.button5:
                ...
                player1 = MediaPlayer.create(Page9.this, R.raw.dolphin);
                player1.start();
            ...
            case R.id.button6:
                ...
                player1 = MediaPlayer.create(Page9.this, R.raw.dracarys);
                player1.start();
                break;
            case R.id.button7:
                if (player1 != null && player1.isPlaying()) {
                ...
                player1 = MediaPlayer.create(Page9.this, R.raw.dragonballbattle);
                player1.start();
                break;
            case R.id.button8:
                if (player1 != null && player1.isPlaying()) {
                ...
                player1 = MediaPlayer.create(Page9.this, R.raw.dramas);
                player1.start();
                break;
            case R.id.button9:
                if (player1 != null && player1.isPlaying()) {
                ...
                player1 = MediaPlayer.create(Page9.this, R.raw.dramatic_chipmunk);
                player1.start();
                break;
            case R.id.previous:
