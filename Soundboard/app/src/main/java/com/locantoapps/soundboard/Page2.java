        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               /* if (myIncent.isAdReadyToDisplay()) {
                    ...
                    myIncent.show(Page2.this, null, null, new AppLovinAdDisplayListener() {
                        @Override
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.button1:
                ...
                player1 = MediaPlayer.create(Page2.this, R.raw.angrycat);
                player1.start();
            ...
            case R.id.button2:
                ...
                player1 = MediaPlayer.create(Page2.this, R.raw.anilloparacuando);
                player1.start();
            ...
            case R.id.button3:
                ...
                player1 = MediaPlayer.create(Page2.this, R.raw.aoehorn);
                player1.start();
            ...
            case R.id.button4:
                ...
                player1 = MediaPlayer.create(Page2.this, R.raw.aot_theme);
                player1.start();
            ...
            case R.id.button5:
                ...
                player1 = MediaPlayer.create(Page2.this, R.raw.applause);
                player1.start();
            ...
            case R.id.button6:
                ...
                player1 = MediaPlayer.create(Page2.this, R.raw.apple);
                player1.start();
                break;
            case R.id.button7:
                if (player1 != null && player1.isPlaying()) {
                ...
                player1 = MediaPlayer.create(Page2.this, R.raw.arrowintheknee);
                player1.start();
                break;
            case R.id.button8:
                if (player1 != null && player1.isPlaying()) {
                ...
                player1 = MediaPlayer.create(Page2.this, R.raw.austinpowerstheme);
                player1.start();
                break;
            case R.id.button9:
                if (player1 != null && player1.isPlaying()) {
                ...
                player1 = MediaPlayer.create(Page2.this, R.raw.avast);
                player1.start();
                break;
            case R.id.previous:
